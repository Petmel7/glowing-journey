<section class="container our-container">
    ...
    <ul class="our-lessons-list">
        <li class="our-lessons-list-children">
            <p class="study-mode">Practice</p>
            <div>
                <span class="our-lessons-list-children-price">40$ / month</span>
            </div>
            <div>
        ...
        <li class="our-lessons-children our-lessons-list-children">
            ...
            <div>
                <span class="our-lessons-list-children-price">70$ / month</span>
            </div>
            <div>
        ...
        <li class="our-lessons-list-children">
            ...
            <div>
                <span class="our-lessons-list-children-price">99$ / month</span>
            </div>
            <div>
